...
- **Dynamic Folder Scanning:** Automatically scans your Windower addon directory to discover valid Lua addons.
...
- **Persistent Configuration:** Saves your custom window sizes, font scales, colors, background textures, and addon states automatically to a configuration file.
...
- **Default Size:** 300x500 pixels (Automatically overrides when Auto-Resize is active).
